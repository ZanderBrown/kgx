...
static void
state_or_size_changed (GObject    *object,
                       GParamSpec *pspec,
                       KgxWindow  *self)
{
                 ...
                 KgxWindow   *self)
{
  ...
  *//* Override some shortcuts from AdwTabView:shortcut-widget back, as they are
...
kgx_window_class_init (KgxWindowClass *klass)
{
  ...
  gtk_widget_class_bind_template_callback (widget_class, state_or_size_changed);
...
kgx_window_init (KgxWindow *self)
{
  ...
  GMenuItem *about_item;

  gtk_widget_init_template (GTK_WIDGET (self));

#if IS_GENERIC
  about_item = g_menu_item_new (_("About Terminal"), "win.about");
#else
  about_item = g_menu_item_new (_("_About King’s Cross"), "win.about");
#endif

  g_menu_append_item (self->primary_menu, about_item);
